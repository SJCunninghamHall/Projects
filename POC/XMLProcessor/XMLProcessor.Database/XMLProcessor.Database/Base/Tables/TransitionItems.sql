CREATE TABLE [Base].[TransitionItems] (
    ...
    CONSTRAINT [pidx_TransitionItems] PRIMARY KEY NONCLUSTERED HASH ([TransitionItemsSKID]) WITH (BUCKET_COUNT = 8388608),
    INDEX [NCI_TransitionItems_TsetIdVrsn_TsetEntity] NONCLUSTERED ([TransactionSetIdWithVersion], [TsetEntityState]),
    INDEX [NCI_TransactionSetId_TsetEntityState] NONCLUSTERED ([TransactionSetId], [TsetEntityState]),
    INDEX [NCI_ItemId] NONCLUSTERED ([UniqueItemIdentifier])
)
