...
AS
	BEGIN
		...
		BEGIN TRY
			...
			ON #ExtractTXSet (TransactionSetIdWithVersion);
			...
			CREATE NONCLUSTERED INDEX ci_TransactionSetIdWithVersion_RKD
...
GRANT
	EXECUTE
ON [Agency].[usp_ReturnAgencyISOMSG06ValidItemsXML]
TO
