CREATE PROCEDURE [Agency].[usp_ReturnAgencyISOMSG06ValidItemsXML]
...
/*****************************************************************************************************
* Name				: [Agency].[usp_ReturnAgencyISOMSG06ValidItemsXML]]
    ...
    BEGIN
		...
		BEGIN TRY 
			...
			BEGIN TRAN
				...
				CREATE CLUSTERED INDEX ci_TransactionSetIdWithVersion ON #ExtractTXSet(TransactionSetIdWithVersion)
			...
			--SELECT * FROM ExtractTXSet
				...
				CREATE NONCLUSTERED INDEX 
					ci_TransactionSetIdWithVersion_RKD 
				ON 
...
GO
GRANT EXECUTE ON [Agency].[usp_ReturnAgencyISOMSG06ValidItemsXML] TO AgencyISOMsgExtractor;
...
EXECUTE sp_addextendedproperty @name = N'Component', @value = N'STAR',
    ...
    @level1name = N'usp_ReturnAgencyISOMSG06ValidItemsXML';
