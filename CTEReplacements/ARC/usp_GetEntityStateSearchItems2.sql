CREATE
PROCEDURE [Web].[usp_GetEntityStateSearchItems]
    @BusinessDate DATE ,
    @SearchType   INT,
    ...
    BEGIN
        ...
        BEGIN
            ...
            IF @RoleName IS NOT NULL
                ...
                END;
                DECLARE
                    @BusinessDateFrom BIGINT;
                    DECLARE
                        @BusinessDateTo BIGINT;
                        DECLARE
                            @AmountFilter NUMERIC(20,2);
                                                                                ...
                                                                                JOIN
                                                                                       (
                                                                                                ...
                                                                                                FROM
                                                                                                         Base.Entity En
                                                                                                         JOIN
                                                                                                                  ReferenceData.EntityStateSearchTypes ESST
                                                                                                                  ON
                               ...
                               , FinalItms AS
                                 (
                                            ...
                                            FROM
                                                       ...
                                                       INNER JOIN
                                                                  [ReferenceData].[RTPPaidEntityStates] RTP
                                                                  ON
                            ...
                            FROM
                                                       ...
                                                       FROM
                                                              (
                                                                           SELECT
                                                                                      ...
                                                                                      , PD.ItemId     AS ItemId
                                                                                      , ROW_NUMBER() OVER (PARTITION BY PD.ItemId ORDER BY
                                                                                                           PD.InternalId DESC) AS RKD
                                                                           FROM
                                                                                        Post.PostingDebit PD
                                                                                        INNER JOIN
                                                                                                     FinalItms
                                                                                                     ON
                                      ...
                                      LEFT JOIN
                                                [Lookup].Currency CUR
                                                ON
                                                          CUR.Id = FinalItms.Currency IF (XACT_STATE()) = 1 BEGIN COMMIT TRANSACTION
                            ;
                ...
                BEGIN
                    ...
                    END CATCH
                END;
                GO GRANT EXECUTE ON [Web].[usp_GetEntityStateSearchItems] TO WebItemRetrieval;
                GO
                EXECUTE sp_addextendedproperty @name = N'Component' ,
                @value                               = N'Cross Client - Long Term Archive (Galaxy)' ,
                @level0type                          = N'SCHEMA' ,
                @level0name                          = N'Web' ,
