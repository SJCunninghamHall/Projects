			...
			FROM
				(
					SELECT 
						...
						[Workflow]
					FROM 
						Manual.AgencySortCode FOR SYSTEM_TIME AS OF @Date SD
					WHERE 
...
END
GO
EXEC sys.sp_addextendedproperty @name=N'Component', @value=N'iPSL.ReferenceDataDB' , @level0type=N'SCHEMA',@level0name=N'RefOut', @level1type=N'PROCEDURE',@level1name=N'usp_GetAgencySortCodeAndAccounts'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This Stored Procedure will fetch the records from [Manual].[AgencySortCode] table with SortCode and Account Number' , @level0type=N'SCHEMA',@level0name=N'RefOut', @level1type=N'PROCEDURE',@level1name=N'usp_GetAgencySortCodeAndAccounts'
GO
EXEC sys.sp_addextendedproperty @name=N'Version', @value=N'$(Version)' , @level0type=N'SCHEMA',@level0name=N'RefOut', @level1type=N'PROCEDURE',@level1name=N'usp_GetAgencySortCodeAndAccounts'
GO
GRANT EXECUTE
    ON OBJECT::[RefOut].[usp_GetAgencySortCodeAndAccounts] TO [Reference_Lloyds_Access];
GO
GRANT EXECUTE
    ON OBJECT::[RefOut].[usp_GetAgencySortCodeAndAccounts] TO [Reference_HSBC_Access];