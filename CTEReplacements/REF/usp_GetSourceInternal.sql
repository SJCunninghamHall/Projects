...
BEGIN
    ...
    BEGIN TRY
		...
		AND 
			NULLIF(DepartmentSortCode,'NULL') IS NULL 

		CREATE NONCLUSTERED INDEX nci_InternalDepartmentID ON #CTE(InternalDepartmentID)
...
END
GO
EXEC sys.sp_addextendedproperty @name=N'Component', @value=N'iPSL.ReferenceDataDB' , @level0type=N'SCHEMA',@level0name=N'Base', @level1type=N'PROCEDURE',@level1name=N'usp_GetSourceInternal'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Insert log details' , @level0type=N'SCHEMA',@level0name=N'Base', @level1type=N'PROCEDURE',@level1name=N'usp_GetSourceInternal'
GO
EXEC sys.sp_addextendedproperty @name=N'Version', @value=N'$(Version)'  , @level0type=N'SCHEMA',@level0name=N'Base', @level1type=N'PROCEDURE',@level1name=N'usp_GetSourceInternal'
GO
GRANT EXECUTE
    ON OBJECT::[Base].[usp_GetSourceInternal] TO [Reference_db_Access]
