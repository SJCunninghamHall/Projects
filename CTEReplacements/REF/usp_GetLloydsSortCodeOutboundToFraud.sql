			...
			BEGIN TRAN
						...
						(
							CASE 
								WHEN NOT EXISTS	(
													...
													INNER JOIN 
														[Manual].BrandSortCodeDetails BSD
													ON 
				...
				LEFT JOIN 
					(
						...
						INNER JOIN 
							Manual.ParticipantAgency FOR SYSTEM_TIME AS OF @Date   PA 
						ON 
...
END
GO
EXEC sys.sp_addextendedproperty @name=N'Component', @value=N'iPSL.ReferenceDataDB' , @level0type=N'SCHEMA',@level0name=N'RefOut', @level1type=N'PROCEDURE',@level1name=N'usp_GetLloydsSortCodeOutboundToFraud'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This Stored Procedure will fetch the Sortcode from EISCD tables.' , @level0type=N'SCHEMA',@level0name=N'RefOut', @level1type=N'PROCEDURE',@level1name=N'usp_GetLloydsSortCodeOutboundToFraud'
GO
EXEC sys.sp_addextendedproperty @name=N'Version', @value=N'$(Version)' , @level0type=N'SCHEMA',@level0name=N'RefOut', @level1type=N'PROCEDURE',@level1name=N'usp_GetLloydsSortCodeOutboundToFraud'
GO
GRANT EXECUTE
    ON OBJECT::[RefOut].[usp_GetLloydsSortCodeOutboundToFraud] TO [Reference_Lloyds_Access];
