        ...
        BEGIN TRY
            BEGIN
				...
				WHERE   
					DI.[MSG07] = 570
				AND 
					DI.PayDecisionReasonCode = '0042' 
				AND 
					DH.MSG06 IN ( 560, 561, 562 )  --it will be either one of the entity state exists always
				AND 
...
GO
GO
	GRANT EXECUTE ON [WAR].[usp_ImageQualityRejectionsReport] TO [RnEWAR]
GO
