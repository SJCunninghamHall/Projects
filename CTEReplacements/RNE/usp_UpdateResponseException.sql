CREATE PROCEDURE [Excep].[usp_UpdateResponseException]
	(
		@ResponseID INT,
		@RneMoID	BIGINT,
		@FileType	VARCHAR(50)
...
GRANT
	EXECUTE
ON OBJECT::[Excep].[usp_UpdateResponseException]
TO
	[RNESVCAccess];
GO
EXECUTE [sys].[sp_addextendedproperty]
	...
	@level1name = N'usp_UpdateResponseException';


GO
EXECUTE [sys].[sp_addextendedproperty]
	@name = N'MS_Description',
	@value = N'This Procedure will load update the response entity',
	@level0type = N'SCHEMA',
	@level0name = N'Excep',
	@level1type = N'PROCEDURE',
	@level1name = N'usp_UpdateResponseException';
