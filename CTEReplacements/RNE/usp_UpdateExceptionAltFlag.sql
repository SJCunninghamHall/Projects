...
BEGIN TRY
	...
	SET 
		...
		,EP.ResponseStatus = 
							CASE
								WHEN ISNULL(ET.ExcepFlag, 0) = 0 AND ET.ResponseSubType IN ('R','O')
...
GRANT EXECUTE
	...
	TO [RNESVCAccess] AS [dbo];
GO

EXECUTE sp_addextendedproperty @name = N'Version', @value = N'$(Version)', @level0type = N'SCHEMA', @level0name = N'Excep', @level1type = N'PROCEDURE', @level1name = N'usp_UpdateExceptionAltFlag';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'This Procedure will update Exception Detail Table with all matching Extracts and Unmatched with new Exception Entity States', @level0type = N'SCHEMA', @level0name = N'Excep', @level1type = N'PROCEDURE', @level1name = N'usp_UpdateExceptionAltFlag';


GO
EXECUTE sp_addextendedproperty @name = N'Component', @value = N'iPSL.ICE.RNE.Database', @level0type = N'SCHEMA', @level0name = N'Excep', @level1type = N'PROCEDURE', @level1name = N'usp_UpdateExceptionAltFlag';
