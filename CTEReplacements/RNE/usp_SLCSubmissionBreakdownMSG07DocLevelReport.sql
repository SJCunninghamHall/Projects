	...
	BEGIN TRY
		...
		BEGIN	
			...
			SELECT  
				...
				DA.Amount AS [Amount],
				CASE 
					WHEN MSG08 IN (SELECT EntityState FROM @MSG08AckRcvd) 
					THEN NULL
...
Grant Execute ON [RnEWareHouseReports].[usp_SLCSubmissionBreakdownMSG07DocLevelReport] to [RnESsrsDwAccess]
