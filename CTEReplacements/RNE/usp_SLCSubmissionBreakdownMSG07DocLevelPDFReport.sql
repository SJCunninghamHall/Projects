...
AS
	BEGIN TRY
		...
		BEGIN	
			...
			DECLARE @MSG08AckRcvd TABLE(EntityState INT)
			...
			SELECT  
				...
				CASE 
					WHEN CONVERT(VARCHAR(8),DC.CreatedDate,108) BETWEEN '00:00:00' AND '10:00:59' THEN 'TimeGroup1'
					WHEN CONVERT(VARCHAR(8),DC.CreatedDate,108) BETWEEN '10:01:00' AND '12:00:59' THEN 'TimeGroup2'
					WHEN CONVERT(VARCHAR(8),DC.CreatedDate,108) BETWEEN '12:01:00' AND '14:30:59' THEN 'TimeGroup3'
					WHEN CONVERT(VARCHAR(8),DC.CreatedDate,108) BETWEEN '14:31:00' AND '15:00:59' THEN 'TimeGroup4'
					WHEN CONVERT(VARCHAR(8),DC.CreatedDate,108) BETWEEN '15:01:00' AND '15:30:59' THEN 'TimeGroup5'
					ELSE 'TimeGroup6'
				END	AS [TimeGroup] ,
				CONVERT(VARCHAR(8),DC.CreatedDate,108) AS [Time] ,
				DC.NumberOfEntries AS [Volume] ,
				CASE 
					WHEN MSG08 IN (SELECT EntityState FROM @MSG08AckRcvd) THEN NULL
...
Grant Execute ON [RnEWareHouseReports].[usp_SLCSubmissionBreakdownMSG07DocLevelPDFReport] to [RnESsrsDwAccess]
